...
class ContSimpleNoisyImageGeneratorMoreSmallCircles(ImageGenerator):
    """
    ...
    """
    def __init__(self, num_images, image_size=(256, 256), square_size=50, min_size=5, max_size=100):
