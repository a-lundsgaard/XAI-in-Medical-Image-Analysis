...
class XAIResNet:
    ...
    def getSaliencyMaps(self, image_count):
        """
        Generate saliency maps for a given set of input images and labels.
        Args:
            input_images (Tensor): The input images tensor.
            input_labels (Tensor): The labels of the input images.
        """
